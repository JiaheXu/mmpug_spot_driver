...
class SpotROS():
    ...
    def handle_trajectory(self, req):
        ...
        rospy.sleep(0.25)
        while self.spot_wrapper._trajectory_status_unknown:
            rospy.logerr("Sent trajectory request to spot but received unknown feedback. Resending command. ")
    ...
    def main(self):
        ...
        # Images # # Not necessary for MMPUG
